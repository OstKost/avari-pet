...
echo -e "☕ \033[1;33mEnjoying Avari? Support the creator:\033[0m"
echo -e "   🇷🇺 Boosty (РФ/СНГ):  \033[4mhttps://boosty.to/ostkost/purchase/4098348?ssource=DIRECT&share=subscription_link\033[0m"
echo -e "   🌎 Buy Me a Coffee: \033[4mhttps://buymeacoffee.com/OstKost\033[0m\n"
